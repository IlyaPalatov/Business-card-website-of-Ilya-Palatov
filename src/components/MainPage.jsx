...
export const MainPage = () => {
    ...
    <div className='box-for-logo'>
        <a href='./MainPage.jsx' className='link-to-main-logo'>
            <p className='logo'>ILLIA.</p>
        </a>
    </div>
    ...
    <div className="desktop-contact-btn">
        <button className='btn-contact-me' onClick={openModal}>
            Let's Talk
        </button>
    </div>
</div>
...
<Modal isOpen={isModalOpen} onClose={closeModal} />
            ...
            <div className='div-about-me' id='about-me'>
                ...
                <div className='my-study'>
                    ...
                    <div className='second-study-txt'>
                        ...
                        <p className='link-to-my-certificate'> Education: Full Stack Developer </p> <a className='link-to-my-education' href="https://drive.google.com/file/d/1223Z3_E39HFtPMX51IxIJucazzyI2LyC/view?usp=sharing">(Certificate)</a>
                    </div>
                </div>
            </div>
            ...
            <div className='footer'>
                <div className='box-of-footer'>
                    <p className='txt-in-footer'>© Copyright {currentYear}. Made by <span className='logo'>ILLIA.</span></p>
                </div>
            </div>
        </div>
    );
