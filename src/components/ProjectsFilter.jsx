...
const ProjectFilter = () => {
  ...
  const projects = [
    {
      id: 1,
      title: 'Tasty Treats (Team Project)',
      type: 'Team Projects',
    ...
    {
      id: 2,
      title: 'Water Tracker (Team Project)',
      type: 'Team Projects',
    ...
    {
      id: 3,
      title: 'Flower Studio (Team Project)',
      type: 'Team Projects',
    ...
    {
      id: 4,
      title: 'Web Studio (Single Project)',
    ...
    {
      id: 5,
      title: 'Web Portfolio (Single Project)',
      type: 'Single Projects',
